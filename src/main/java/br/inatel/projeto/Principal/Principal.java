...
import br.inatel.projeto.BD.AlugadoBD;
import br.inatel.projeto.BD.ClienteBD;
import br.inatel.projeto.BD.JogoBD;
...
public class Principal {
    public static void main(String[] args) {
        ...
        JogoBD jogos = new JogoBD();
        ClienteBD clientes = new ClienteBD();
        AlugadoBD alugados = new AlugadoBD();
        int id;
        boolean flag = true;
        while (flag) {
            System.out.println("Selecione uma opçao do menu:");
            ...
            System.out.println("11 - Remover  um cliente");
